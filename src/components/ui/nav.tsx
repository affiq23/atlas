  ...
  return (
    ...
    >
      <nav className="mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link 
          href="/" 
          className="flex items-center gap-2 text-gray-900 hover:text-[#0EA5E9] transition-colors"
        >
          ...
          {!loading && (
            user ? (
              <>
                <Link 
                  href="/explore" 
                  className="text-sm font-medium px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors"
                >
                  Explore
                </Link>
                <Link 
